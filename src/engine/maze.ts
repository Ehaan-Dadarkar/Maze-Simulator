...
export function makeMaze(size=23):Maze{return{size,roads:new Set(),start:{x:20,y:18},end:{x:7,y:18},checkpoints:new Set(),referenceShortest:[]};}
...
/** END sensor zone. The supplied reference has the white END box occupying columns 6–9 and rows 17–20. */
